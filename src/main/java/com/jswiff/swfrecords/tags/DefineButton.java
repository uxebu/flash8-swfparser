...
public class DefineButton extends DefinitionTag {
	protected ButtonRecord[] characters;
	private ActionBlockReader actionBlock;
	...
	public ActionBlockReader getActions() {
		if (actionBlock == null) {
			actionBlock = ActionBlock.getInstance(); // lazy init
		}
		return actionBlock;
	}
...
//		actionBlock = new ActionBlock(inStream);
		actionBlock = ActionBlock.getInstance();
		actionBlock.read(inStream);
