...
public abstract class AssignIncrementOperation extends SimpleIncrementOperation implements AssignOperation, DualUse {

	protected boolean isStatement = false;
	
	public AssignIncrementOperation(Operation op) {
		super(op);
	}
	
	public AssignIncrementOperation(Operation op, boolean isStatement) {
		super(op);
		this.isStatement = isStatement;
	}

	public AssignIncrementOperation(Stack<Operation> stack) {
		super(stack);
	}
