 ...
 * @see ClipActions
 */
public class ClipActionRecord implements Serializable {
  protected ClipEventFlags eventFlags;
  protected short keyCode;
  private ActionBlockReader actions;

  private static Logger logger = Logger.getLogger(ClipActionRecord.class);
  ...
  public ClipActionRecord(InputBitStream stream, short swfVersion)
    ...
    logger.debug("actionRecordSize="+UnsignedByte.hex(actionRecordSize));
