...
/**
 * This class is used by <code>DefineFunction2</code> to specify the
 * function's parameters. These can be either variables or registers.
 */
public final class RegisterParam implements Serializable {
	...
	/**
	 * Creates a new RegisterParam instance. If you use 0 as register number,
	 * the parameter can be referenced as a variable within the function (this
	 * variable's name is contained in <code>paramName</code>). If the
	 * register number is greater than 0, the parameter is copied into the
